  ...
  return (
    ...
    <>
      <div id="bio-card">
        ...
        <p class="lead">Born in Thessaloniki, in 1997. Always keen on the study of the natural world, as well
          as informatics & computer programming. Studied <span class="text-warning">Geology and Earth
          ...
          8.63/10.00). Actively involved in research on <a
            ...
            target="_blank"><span class="text-success">remote sensing and
